            ...
            <div>
                ...
                <nav class="space-y-2">
                    ...
                    <Link 
                        ...
                        class="group flex items-center gap-3.5 px-4 py-3.5 rounded-2xl text-sm font-semibold transition-all duration-300 relative overflow-hidden"
                        :class="[
                            $page.component === 'SuperAdmin/Finance' 
                                ? 'bg-gradient-to-r from-indigo-600 to-indigo-500 text-white shadow-lg shadow-indigo-600/15' 
                                : 'text-[var(--text-muted)] hover:text-[var(--text-main)] hover:bg-[var(--bg-btn-secondary)]'
                        ]"
                    >
                        <div v-if="$page.component === 'SuperAdmin/Finance'" class="absolute left-0 top-3.5 bottom-3.5 w-1 bg-white rounded-r-full"></div>
                        <i class="fa-solid fa-coins text-base transition-transform group-hover:scale-110 duration-300" :class="[$page.component === 'SuperAdmin/Finance' ? 'text-white' : 'text-indigo-500/70 group-hover:text-indigo-500']"></i>
