                ...
                >
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1.5">
                            ...
                            <p class="text-4xl font-black tracking-tight" :style="{ color: (theme === 'light' || theme?.value === 'light') ? '#0f172a' : '#ffffff' }">{{ stats.total_companies }}</p>
                        </div>
                ...
                >
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1.5">
                            ...
                            <p class="text-4xl font-black tracking-tight" :style="{ color: (theme === 'light' || theme?.value === 'light') ? '#0f172a' : '#ffffff' }">{{ stats.total_users }}</p>
                        </div>
                ...
                >
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1.5">
                            ...
                            <p class="text-4xl font-black tracking-tight" :style="{ color: (theme === 'light' || theme?.value === 'light') ? '#0f172a' : '#ffffff' }">{{ stats.total_agencies }}</p>
                        </div>
                ...
                >
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1.5">
                            ...
                            <p class="text-4xl font-black tracking-tight" :style="{ color: (theme === 'light' || theme?.value === 'light') ? '#0f172a' : '#ffffff' }">{{ stats.total_tenants }}</p>
                        </div>
