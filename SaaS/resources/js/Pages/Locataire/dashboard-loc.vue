        ...
        <div :key="activeTab" class="page-panel" :class="{ 'lang-switching': switchingLang }">
          ...
          <section v-else-if="activeTab === 'loyer'" class="tab-section anim-section">
            ...
            <div class="glass-card rent-payment-selector-card">
              ...
              <p v-if="contracts && contracts.length > 0" class="card-subtitle-text">
              ...
              <p v-else class="card-subtitle-text" style="color:var(--amber);">
                Aucun contrat actif trouvé. Vous n'avez pas de loyers à régler pour le moment.
              </p>
...
const navItems = computed(() => [
  ...
  { id: 'immotok', label: 'ImmoTok', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 3 19 12 5 21 5 3"/></svg>', badge: null },
])
