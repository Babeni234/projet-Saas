...
onMounted(() => {
    ...
    if (storedInvoices) {
        ...
        invoices.value = [
            { id: 1, numero: 'FAC-2026-001', locataire: 'Jean Dupont', logement: 'Apt 204', batiment: 'Immeuble A', periode: '2026-05', items: [{ libelle: 'Loyer mensuel HC', montant: 1200 }, { libelle: 'Provisions de charges', montant: 80 }], total: 1280, montantPaye: 1280, statut: 'Payé' },
            { id: 2, numero: 'FAC-2026-002', locataire: 'Marie Lambert', logement: 'Bureau 102', batiment: 'Immeuble B', periode: '2026-05', items: [{ libelle: 'Loyer commercial HC', montant: 2500 }, { libelle: 'Charges syndic', montant: 150 }], total: 2650, montantPaye: 1000, statut: 'Partiellement payé' },
            { id: 3, numero: 'FAC-2026-003', locataire: 'Pierre Martin', logement: 'Apt 305', batiment: 'Immeuble C', periode: '2026-05', items: [{ libelle: 'Loyer mensuel HC', montant: 950 }], total: 950, montantPaye: 0, statut: 'Impayé' }
        ];
