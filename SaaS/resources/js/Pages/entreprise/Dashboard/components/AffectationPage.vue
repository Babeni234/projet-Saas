    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-slate-600 mt-1">Attribuer et gérer l'occupation des biens immobiliers par les locataires</p>
            </div>
            <button
                @click="openAddModal"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-slate-200/50 p-6 border border-slate-100 transform transition-all duration-300 hover:scale-[1.03]">
                ...
                <p class="text-xs text-slate-400 mt-4">{{ totalVacant }} biens vacants prêts à l'affectation</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-slate-200/50 p-6 border border-slate-100 transform transition-all duration-300 hover:scale-[1.03]">
                ...
                <p class="text-xs text-slate-400 mt-4">Fonds de garantie sécurisés</p>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr v-if="filteredAffectations.length === 0">
                            <td colspan="8" class="text-center py-12 text-slate-400">
                                Aucune affectation active ou archivée.
                            </td>
                        </tr>
                    </tbody>
                </table>
...
const onLogementChange = () => {
    ...
    if (details) {
        ...
        formData.value.caution = Number(details.loyer || 0); // Autofill caution = 1 month rent by default
