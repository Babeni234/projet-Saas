                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-100 text-sm">
                            ...
                            <tr v-if="pendingExpensesList.length === 0">
                                <td colspan="3" class="px-4 py-6 text-center text-slate-400 italic">Aucune dépense en attente</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-100 text-sm">
                            ...
                            <tr v-if="cancelledExpensesList.length === 0">
                                <td colspan="3" class="px-4 py-6 text-center text-slate-400 italic">Aucune dépense annulée</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
