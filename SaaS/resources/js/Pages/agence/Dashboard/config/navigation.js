        ...
        items: [
            {
                ...
                children: [
                    ...
                    { name: 'agence.immobilier.logements', label: 'Biens Immobiliers' },
                    { name: 'agence.immobilier.illustrations', label: 'Illustrations' },
        ...
        items: [
            {
                ...
                children: [
                    ...
                    { name: 'agence.accounting.depenses', label: 'Dépenses' },
                    { name: 'agence.accounting.entrees-fonds', label: 'Autres entrées de fonds' },
                ],
            },
...
export const routeTitles = {
    ...
    'agence.accounting.depenses': 'Dépenses',
    'agence.accounting.entrees-fonds': 'Autres entrées de fonds',
