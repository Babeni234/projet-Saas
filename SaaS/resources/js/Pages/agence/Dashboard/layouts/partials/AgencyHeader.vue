        ...
        <div class="flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex shrink-0 items-center gap-2 sm:gap-3">
                ...
                <button
                    type="button"
                    @click="toggleLocale"
                    class="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-bold text-slate-700 shadow-sm transition hover:border-amber-300 hover:bg-amber-50 hover:text-amber-700"
                ...
                <div class="bg-gradient-to-br from-white via-white to-red-50/10 rounded-3xl shadow-2xl max-w-md w-full p-8 border border-red-100/50 relative overflow-hidden animate-scale-up text-left">
                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <p class="text-slate-650 text-sm mb-6 leading-relaxed">
                            {{ locale === 'fr' ? 'Voulez-vous vraiment vous déconnecter de l\'agence' : 'Do you really want to log out of agency' }}
