    ...
    >
        ...
        <div class="imo-page">
            ...
            <div class="imo-stats-grid-4 mb-8">
                <div class="imo-stat-card">
                    ...
                    <div>
                        ...
                        <p class="imo-stat-label">Total logements</p>
                    </div>
                </div>
                ...
                <div class="imo-stat-card">
                    ...
                    <div>
                        ...
                        <p class="imo-stat-label">Actifs</p>
                    </div>
                </div>
                ...
                <div class="imo-stat-card">
                    ...
                    <div>
                        ...
                        <p class="imo-stat-label">Loués</p>
                    </div>
                </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex flex-1 flex-col justify-between">
                            ...
                            <div class="mt-4 flex items-center justify-between border-t border-slate-100 pt-3">
                                ...
                                <div class="flex items-center gap-2">
                                    <Link
                                        :href="route('immo.property.show', property.id)"
                                        class="imo-btn-sm imo-btn-sm-secondary"
                                    >
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    ...
                                    <Link
                                        :href="route('immo.property.edit', property.id)"
                                        class="imo-btn-sm imo-btn-sm-secondary"
                                    >
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <Link
                                        :href="route('immo.property.destroy', property.id)"
                                        method="delete"
                                        class="imo-btn-sm imo-btn-sm-danger"
                                    >
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-else class="imo-empty-state-lg">
                ...
                <h3 class="mt-4 text-lg font-semibold text-slate-900">Aucun logement enregistré</h3>
                <p class="mt-2 text-sm text-slate-500">Commencez par ajouter votre premier bien immobilier.</p>
                <Link
                    :href="route('immo.property.create')"
