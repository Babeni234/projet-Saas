...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/espace-bailleur', function () {
        ...
        return $controller->__invoke();
    })->middleware('landlord.verified')->name('immo.bailleur');

    // Routes pour la vérification du statut de bailleur
    ...
    // Routes pour les contrats (bailleur)
    ...
    // Routes pour les quittances (bailleur)
    ...
    // Routes pour le calendrier visites (bailleur)
    ...
    // Quick-create publication (bailleur) - non-invasive placeholder
    ...
    // Recherches enregistrées (particulier) - placeholder
    ...
    // Routes pour les analytiques (bailleur)
