...
class AgencyTest extends TestCase
{
    ...
    {
        // Missing required name, status (code is optional/nullable now)
        $response = $this->actingAs($this->user)
    ...
    public function test_agency_can_be_stored_without_code_and_gets_autogenerated_code(): void
    {
        $payload = [
            'name' => 'Agence Auto Code',
            'status' => 'active',
            'email' => 'autocode@nac.com',
        ];
        ...
        $agency = Agency::where('name', 'Agence Auto Code')->first();
        $this->assertNotNull($agency);
        $this->assertStringStartsWith('AG-', $agency->code);
        $this->assertNotNull($agency->uuid);
        $this->assertEquals(0, $agency->synced);
    }
